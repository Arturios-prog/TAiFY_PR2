...
public class StateMachine {
    ...
    /**
     * Получение следующего состояния по текущему состоянию и
     входному символу.
     *
     ...
     * значение, если подстрока сопоставлена с регулярным выражением -
    индекс в строке символа, следующего за
